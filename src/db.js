...
const BOOKING_COLUMNS = `
  ...
  agreed_split_pct, agreed_lead_split_pct,
...
export async function reassignBooking(env, bookingId, fromUserId, toUserId) {
  ...
  const writes = [
    ...
    ).bind(toUserId, pointAt, toUserId, toUserId, ts, bookingId, fromUserId),
  ];
 ...
 * agreement that has not been reached yet belongs. See 0074_agreed_split.sql.
 */
const AGREED_SPLIT_SQL = `
